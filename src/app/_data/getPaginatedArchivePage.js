...
export const DEFAULT_ARCHIVE_PAGE_LIMIT = 40;
const MAX_LIMIT = 60;
...
export function encodeArchivePageCursor(payload) {
...
/**
 * Shared paginated archive fetch used by the API route and SSR first page.
 */
export async function getPaginatedArchivePage({
  cursor = null,
  limit: rawLimit = DEFAULT_ARCHIVE_PAGE_LIMIT,
  sortColumn = null,
  sortDirection = null,
  ...
  const nextCursor = hasMore ? encodeArchivePageCursor({ offset: nextOffset, signature }) : null;
